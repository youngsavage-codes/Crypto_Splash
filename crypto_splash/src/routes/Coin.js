        ...
        <div className='content'>
          ...
          <div className='info'>
            ...
            <div className='coin-price'>
              <h1>${coin.market_data?.current_price ? <h1>{coin.market_data.current_price.usd}</h1> : null}</h1>
            </div>
          ...
          <div className='content'>
            <div className='stats'>
              ...
              <div className='left'>
                  <div className='row'>
                    <h4>24 Hour Low</h4>
                    <p>{coin.market_data?.low_24h ? <>{coin.market_data.low_24h.usd}</> : null}</p>
                  </div>
                  <div className='row'>
                    <h4>24 Hour High</h4>
                    <p>{coin.market_data?.high_24h ? <>{coin.market_data.high_24h.usd}</> : null}</p>
                  </div>
              </div>
              ...
              <div className='right'>
                  <div className='row'>
                    <h4>Market Cap</h4>
                    <p>{coin.market_data?.market_cap ? <>{coin.market_data.market_cap.usd}</> : null}</p>
                  </div>
                  <div className='row'>
                    <h4>Circulating Supply</h4>
                    <p>{coin.market_data?.circulating_supply ? <>{coin.market_data.circulating_supply}</> : null}</p>
                  </div>
              </div>
